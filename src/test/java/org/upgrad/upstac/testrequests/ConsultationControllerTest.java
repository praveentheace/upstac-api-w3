...
class ConsultationControllerTest {
    ...
    public void calling_assignForConsultation_with_valid_test_request_id_should_update_the_request_status() {
        ...
        TestRequest anotherTestRequest = consultationController.assignForConsultation(testRequest.getRequestId());
        ...
        assertThat("id should be same", testRequest.getRequestId(), equalTo(anotherTestRequest.getRequestId()));
        assertThat("status should be DIAGNOSIS_IN_PROCESS", anotherTestRequest.getStatus(), equalTo(RequestStatus.DIAGNOSIS_IN_PROCESS));
    ...
    public void calling_assignForConsultation_with_valid_test_request_id_should_throw_exception() {
        ...
        ResponseStatusException error = assertThrows(ResponseStatusException.class, () -> consultationController.assignForConsultation(InvalidRequestId));


        //Use assertThat() method to perform the following comparison
        //  the exception message should be contain the string "Invalid ID"
        assertThat("exception should contain Invalid ID", error.getMessage(), equalTo("Invalid ID"));
    ...
    public void calling_updateConsultation_with_valid_test_request_id_should_update_the_request_status_and_update_consultation_details() {
        ...
        TestRequest anotherTestRequest = consultationController.updateConsultation(1L, consultationRequest);
        ...
        assertThat("id should be same", testRequest.getRequestId(), equalTo(anotherTestRequest.getRequestId()));
        assertThat("status should be COMPLETED", anotherTestRequest.getStatus(), equalTo("COMPLETED"));
        assertThat("suggestion should be same", testRequest.getConsultation().getSuggestion(), equalTo(anotherTestRequest.getConsultation().getSuggestion()));
    ...
    public void calling_updateConsultation_with_invalid_test_request_id_should_throw_exception() {
        ...
        //Create an object of CreateConsultationRequest and call getCreateConsultationRequest() to create the object. Pass the above created object as the parameter
        CreateConsultationRequest consulationRequest = getCreateConsultationRequest(testRequest);
        ...
        ResponseStatusException error = assertThrows(ResponseStatusException.class, () -> consultationController.updateConsultation(-1L, consulationRequest));


        //Use assertThat() method to perform the following comparison
        //  the exception message should be contain the string "Invalid ID"
        assertThat("message should contain Invalid ID", error.getMessage(), equalTo("Invalid ID"));
    ...
    public void calling_updateConsultation_with_invalid_empty_status_should_throw_exception() {
        ...
        //Refer to the TestRequestControllerTest to check how to use assertThrows() method
        assertThrows(ResponseStatusException.class, () -> consultationController.updateConsultation(testRequest.getRequestId(), consulationRequest));
    ...
    public CreateConsultationRequest getCreateConsultationRequest(TestRequest testRequest) {
        ...
        if (testRequest.getLabResult().getResult().equals(TestStatus.POSITIVE)) {
            ...
            consultationRequest.setComments("home quarantine needed");
            ...
            consultationRequest.setComments("No issues");
        }
